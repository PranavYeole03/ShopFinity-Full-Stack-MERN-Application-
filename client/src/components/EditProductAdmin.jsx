            ...
            <form className="grid gap-4" onSubmit={handleSubmit}>
              ...
              <div className="grid gap-1">
                ...
                <textarea
                  ...
                  multiple
                  rows={3}
                  className="bg-white p-2 outline-none border focus-within:border-primary-200 rounded resize-none"
                />
              </div>
              <div>
                ...
                <div>
                  <label
                    ...
                    className="bg-white h-24 border rounded flex justify-center items-center cursor-pointer"
                  >
                    ...
                    {data.category.map((c, index) => {
                      return (
                        <div
                          ...
                          className="text-sm flex items-center gap-1 bg-white mt-2"
                        >
                          <p>{c.name}</p>
                          <div
              ...
              <div className="grid gap-1">
                ...
                <input
                  ...
                  onChange={handleChange}
                  required
                  className="bg-white p-2 outline-none border focus-within:border-amber-200 rounded"
                />
              </div>
              ...
              <div className="grid gap-1">
                ...
                <input
                  ...
                  onChange={handleChange}
                  required
                  className="bg-white p-2 outline-none border focus-within:border-amber-300 rounded"
                />
              </div>
              ...
              <div
                ...
                className=" hover:bg-primary-200 bg-white py-1 px-3 w-32 text-center font-semibold border border-primary-200 hover:text-neutral-900/60 cursor-pointer rounded"
              >
                Add Fields
              </div>

              <button className="bg-amber-200 hover:bg-amber-400 py-2 rounded font-semibold">
                Update Product
              </button>
            </form>
          </div>
