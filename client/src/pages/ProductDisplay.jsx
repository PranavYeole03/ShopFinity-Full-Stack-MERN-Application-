    ...
    <section className="container mx-auto p-4 grid lg:grid-cols-2">
      <div className="">
        ...
        <div className="flex items-center justify-center gap-3 my-2">
          {data.image.map((img, index) => {
            return (
              <div
                key={img + index}
                className={`bg-slate-200 cursor-pointer w-3 h-3 lg:w-5 lg:h-5 rounded-full ${
        ...
        <div className="grid relative">
          ...
          <div className="w-full -m1-3 h-full hidden lg:flex justify-between absolute items-center">
            <button
              onClick={handleScrollLeft}
              className="z-10 bg-white relative p-1 rounded-full shadow-lg hover:bg-red-400"
            >
              <FaAngleLeft size={20} />
            </button>
            <button
              onClick={handleScrollRight}
              className="z-10 bg-white relative p-1 rounded-full shadow-lg hover:bg-green-400"
            >
      ...
      <div className="p-4 lg:pl-7 text-base lg:text-lg">
        ...
        <p className="font-stretch-50%">{data.unit}</p>
        <Divider />
        <div>
          <p className="">Price</p>
        ...
        {data.stock === 0 ? (
          <p className="text-lg text-red-400 my-2 ">Out of Stock</p>
        ) : (
        ...
        <h2 className="font-semibold">Why Shop From ShopFinity?</h2>
        <div>
          ...
          <div className="flex items-center gap-4 my-4">
            ...
            <div className="text-sm">
              ...
              <p>
                Best price destination with offer directly from the
                manufactures.
              </p>
            </div>
          </div>
          <div className="flex items-center gap-4 my-4">
            ...
            <div className="text-sm">
              ...
              <p>
                Choose from 5000+ products acoss food personal care,household
