...
const ProductCardAdmin = ({ data, fetchProductData }) => {
  ...
  return (
    <div className="w-36 p-4 border-blue-500  rounded ">
      <div>
        <img
          src={data?.image[0]}
          alt={data?.name}
      ...
      {openDelete && (
        <section className="fixed top-0 left-0 right-0 bottom-0 bg-neutral-600/60 z-50  p-4 flex justify-center items-center ">
