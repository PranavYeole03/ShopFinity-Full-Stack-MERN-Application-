...
const SubCategory = () => {
  ...
  const [deletSubCategory, setDeleteSubCategory] = useState({
    _id: "",
  });
        ...
        return (
          <div className="flex items-center justify-center gap-3">
            ...
            <button
              ...
              className="p-2 bg-red-50 rounded-full hover:text-yellow-300 cursor-pointer"
            >
              <MdDelete size={20} />
            </button>
          </div>
  ...
  return (
    <section>
      ...
      <div className="overflow-auto w-full max-w-[120vh]">
